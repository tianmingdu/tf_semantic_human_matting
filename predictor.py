...
class Predictor(object):
    ...
    def __init__(self,
        ...
        self.alpha_matte_p = self._graph.get_tensor_by_name('alpha_matte_p:0')
        self.alpha_matte_p_discrete = self._graph.get_tensor_by_name('alpha_matte_p_discrete:0')
    ...
    def predict(self, images, trimaps=None):
        ...
        [alpha_matte_p, alpha_matte_p_discrete] = self._sess.run(
            [self.alpha_matte_p, self.alpha_matte_p_discrete],
            feed_dict=feed_dict)
        return alpha_matte_p, alpha_matte_p_discrete
