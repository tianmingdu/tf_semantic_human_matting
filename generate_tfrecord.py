...
def create_tf_example(image_fg_path, image_bg_path, trimap_path, mask_path,
                      resize_size=None):
...
def generate_tfrecord(image_paths, output_path, resize_size=None):
    ...
    for image_fg_path, image_bg_path, trimap_path, mask_path in image_paths:
        ...
        tf_example = create_tf_example(image_fg_path, image_bg_path, 
                                       trimap_path, mask_path, resize_size)
